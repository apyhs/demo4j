...
public class BitTorrentInfo {
    ...
    public BitTorrentInfo(String announce, List<String> announceList
            , long creationDate, String comment, String createBy, Info info) {
        super();
    ...
    public void setValue(String key, Object value) {
        if (!keyList.contains(key)) {
            throw new RuntimeException("not contains this key: " + key);
        } else {
            switch (key) {
                case "announce":
