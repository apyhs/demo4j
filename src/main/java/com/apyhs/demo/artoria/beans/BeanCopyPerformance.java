...
import com.apyhs.artoria.beans.CglibBeanCopier;
...
import com.apyhs.demo.artoria.entity.Menu;
import com.apyhs.demo.artoria.entity.MenuVO;
...
public class BeanCopyPerformance {
    ...
    public void artoria(Report report) throws Exception {
        com.apyhs.artoria.beans.BeanUtils.setBeanCopier(new CglibBeanCopier());
        final MenuVO vo = new MenuVO();
