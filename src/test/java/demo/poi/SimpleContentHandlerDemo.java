...
public class SimpleContentHandlerDemo extends DefaultHandler {
    ...
    public SimpleContentHandlerDemo( OutputStream out )
    {
        this( out, null );
    }

    public SimpleContentHandlerDemo( OutputStream out, Integer indent )
    {
        this( out, null, indent );
    }

    public SimpleContentHandlerDemo( Writer writer )
    {
        this( writer, null );
    }

    public SimpleContentHandlerDemo( Writer writer, Integer indent )
    {
        this( null, writer, indent );
    }

    private SimpleContentHandlerDemo( OutputStream out, Writer writer, Integer indent )
    {
        this.out = out;
        this.writer = writer;
